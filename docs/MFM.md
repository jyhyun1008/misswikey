...
표를 만들고 표 안에 문서를 링크할 수 있습니다.

| 제목 | 제목 |
|---|---|
| 내용 | *[내용](예제.md) |

이 때, 링크 건 문서에는 반드시 링크 앞에 아스테리스크 기호(*)를 붙여야만 합니다.
또한, 깃허브 내에서는 작동되지 않지만, 미스키에서 렌더링할 때 칸을 합칠 수 있습니다.

|| 제목 |
|---|---|
| 내용 | 내용 |

타 위키 문법과 반대로 앞쪽에 세로선이 들어가는 것을 유념해주세요.
